...
class Application(App):
    ...
    def build(self):
        ...
        text = Label(text="Выберите ваш курс обучения", font_size=40, pos_hint={'x':0,'y':.44}, color="black")
    ...
    def tomain(self):
        ...
        print(self.img1.pos_hint)
        print(self.img2.pos_hint)
        print(self.img3.pos_hint)
        print(self.img4.pos_hint)
        print(self.img5.pos_hint)
